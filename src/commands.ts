...
export const baseCommandToFetchFunction = new Map<string, FetchFunction>([
  ...
  ['gunzip', openbsd.fetchGunzip],
  ['gzcat', openbsd.fetchGzcat],
  ['gzip', openbsd.fetchGzip],
  ['halt', openbsd.fetchHalt],
